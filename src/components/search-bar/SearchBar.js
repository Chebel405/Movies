            ...
            >
                {({handleSubmit, handleChange, handleBlur, isSubmitting}) => (
                    <form className="d-flex flex-row p-2 m-2" onSubmit={handleSubmit}>
                        <input name="query" className="flex-fill form-control mr-2"placeholder="Search.."
                        ...
                        <select className="mr-2 form-control w-25"name="language"onChange={handleChange} onBlur={handleBlur}>
                            ...
                            <option values="fr-FR">Francais</option>
                        </select>
                        <button className="btn btn-small btn-succes" type="submit"disabled={isSubmitting}>Submit</button>
                    </form>
                )}
            </Formik>
        )
